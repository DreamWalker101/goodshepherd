...
$PAGE_NAMES = [
    ...
    'extraCurricular' => 'Extra-Curricular', 'wellbeing' => 'Wellbeing',
...
<head>
  ...
  <title>Good Shepherd Primary School — Content Editor</title>
  ...
  <style>
    ...
    * { box-sizing:border-box; }
    ...
    input[type=text]:focus, textarea:focus { outline:none; border-color:var(--primary); box-shadow:0 0 0 2px rgba(19,75,149,.15); }
...
<div class="app">
  <aside class="side">
    <div class="side-brand">Good Shepherd<br>Content Editor</div>
