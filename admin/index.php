...
<head>
  ...
  <title>Admin Login — Good Shepherd Primary School</title>
  ...
  <style>
    ...
    .pp-input:focus { border-color: #134b95; box-shadow: 0 0 0 2px rgba(19,75,149,0.18); }
    ...
    .pp-btn-secondary:hover { color: #134b95; }
    .pp-error {
      display: flex;
      align-items: center;
      gap: 8px;
    ...
    .pp-step-hint strong { color: #134b95; font-weight: 600; }
    .pp-page-footer {
      text-align: center;
      margin-top: 28px;
      font-size: 12px;
...
<body class="min-h-screen flex flex-col items-center justify-center p-6">
  ...
  <p class="pp-page-footer">Good Shepherd Primary School, Wheelers Hill</p>
