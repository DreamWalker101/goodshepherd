...
$SITE = "Good Shepherd Primary School";
$TO   = $g['email'] ?? 'gsoffice@gswheelershill.catholic.edu.au';
$FROM = 'noreply@gswheelershill.catholic.edu.au';
...
<style>
 ...
 .tick{width:64px;height:64px;border-radius:50%;background:#134b95;color:#fff;font-size:32px;line-height:64px;margin:0 auto 18px;}
 h1{font-size:22px;margin:0 0 10px;} p{color:#6b7682;line-height:1.55;margin:0 0 22px;}
 a{display:inline-block;background:#134b95;color:#fff;text-decoration:none;padding:11px 24px;border-radius:8px;font-weight:600;}
</style></head>
<body>
 <div class="card">
